...
const dictionary: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    sound: 'Sound',
    stats: 'Stats',
    thiefDisabled: 'Thief cannot fire anymore — Screw ends the round immediately.',
  ...
  ar: {
    ...
    sound: 'الصوت',
    stats: 'الإحصائيات',
    thiefDisabled: 'حركة اللص مش شغالة لأن السكرو بيقفل الجولة.',
...
// No encouragement reactions — removed to reduce noise
